...
/**
 *  \def HEAP_GROWTH
 *  Which way the heap grows (usually opposite of stack growth).
 *
 *  | VALUE  |  DESCRIPTION                   |
 *  |--------|--------------------------------|
...
/**
 *  \def STACK_GROWTH
 *  Which way the stack grows (usually opposite of heap growth).
 *
 *  | VALUE  |  DESCRIPTION                   |
 *  |--------|--------------------------------|
 *  | UP     |  **LOW**- to **HIGH** address  |
 ...
 *   |D|D|D|D|D|D|D|D|D|D|D|A|A|T|T| <- A represents size or bitvector (0 or 1)
 *   ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾ 
 *   ```
 *   (T) The 2 last bits, is the header type.
 *   (A=0) represents raw size of object (in bytes)
 *   (A=1) represents a bit vector mapping data pointers within the object. 
 *
 *   ## RAW SIZE
